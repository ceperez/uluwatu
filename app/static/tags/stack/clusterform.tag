                              ...
                              <div class="panel panel-default" style="border-top-left-radius: 0.5em; border-top-right-radius: 0.5em;">
                                ...
                                <div class="panel-body">
                                  <div class="form-group" name="templateNodeform{{$index}}" >
                                    ...
                                    <div class="col-sm-9">
                                      <input type="number" name="templateNodeCount{{$index}}" ng-disabled="isMaster(instanceGroup.group) || instanceGroup.type=='AMBARI_SERVER'" class="form-control" ng-model="instanceGroup.nodeCount" id="templateNodeCount{{$index}}" min="1" max="100000" placeholder="1 - 100000" required>
                                        <div class="help-block"
